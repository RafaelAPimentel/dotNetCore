...
namespace RequestRateLimiting
{
    public  class AwesomeRateLimiterMiddleware
    {
        ...
        public async Task Invoke(HttpContext context) {
            ...
            int hitCount = 0;
            var cacheEntryOptions = new MemoryCacheEntryOptions() { AbsoluteExpiration = DateTime.Now.AddSeconds(30) };
        ...
        private async Task ProcessRequest(HttpContext context, string requestKey,int hitCount, MemoryCacheEntryOptions cacheEntryOption) {
            hitCount++;
            requestStore.Set(requestKey, hitCount, cacheEntryOption);
